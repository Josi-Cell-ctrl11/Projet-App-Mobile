...
class _OtpScreenState extends ConsumerState<OtpScreen> {
  ...
  Future<void> _renvoyerCode() async {
    ...
    await FirebaseAuth.instance.verifyPhoneNumber(
      ...
      verificationCompleted: (credential) => _completeSignIn(credential),
      verificationFailed: (e) {
        if (!mounted) return;
        setState(() {
          _resending = false;
          _error = e.message ?? "Impossible de renvoyer le code";
        });
      },
      codeSent: (verificationId, resendToken) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Nouveau code envoyé par SMS")),
        );
      },
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text: formatPhoneDisplay(widget.phone),
                      style: const TextStyle(
              ...
              Center(
                child: TextButton(
                  onPressed: _resending ? null : _renvoyerCode,
                  child: Text(
